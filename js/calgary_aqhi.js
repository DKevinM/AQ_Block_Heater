...
function drawCalgaryPanel() {
  ...
  ">
    ...
    <div style="font-size:12px; color:#555; margin-top:4px;">
      Click any location on the map for local weather, nearest stations, and sensors.
    </div>
    ...
    <div style="margin-top:10px; font-weight:600;">Local Weather (current + next 6 hours)</div>
    <div id="weather-info" style="margin-top:6px; border:1px solid #999; border-radius:6px; padding:8px;"></div>
